...
def ProcessData(filePath1, filePath2, saveName= None, sampleN = 15, ch2Offset = -0.3, trimN = 100, gainCh1 =1, gainCh2 = 2,
    ...
    signal1 = emgMath.processExgData(data1, samples = sampleN, ch2Offset = ch2Offset, trimN = trimN, title = title1, gainCh1= gainCh1, gainCh2 = gainCh2, type = type1)
    signal2 = emgMath.processExgData(data2, samples = sampleN, ch2Offset = ch2Offset, trimN = trimN, title = title2, gainCh1= gainCh1, gainCh2 = gainCh2, type = type2)
